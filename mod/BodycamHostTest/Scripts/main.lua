...
log("F4 = apply configured limit to active TeamConfig; F5 = recover one unassigned bot")
...
log("F6 = team diagnostic; F7 = spawn one bot and track it")
...
RegisterKeyBind(Key.F7, function() dispatch(botTest.press) end)
RegisterKeyBind(Key.F6, function() dispatch(botTest.inspect) end)
RegisterKeyBind(Key.F5, function() dispatch(botTest.recover) end)
